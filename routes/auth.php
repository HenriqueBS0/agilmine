...
use App\Livewire\Sprint\Eventos\Acessar\Pagina as PaginaSprintEventoAcessar;
...
Route::middleware('guest')->group(function () {
    ...
    Route::post('login/default', [AuthenticatedSessionController::class, 'loginWithDefaultUser'])
        ->name('login.default');
...
Route::middleware(['auth', 'check.user.status'])->group(function () {
    ...
    Route::prefix('/sprint/{sprint}')->middleware(['sync.projects', 'can:isAtiva,sprint'])->group(function () {
        ...
        Route::get('/acessar-evento/{evento}', PaginaSprintEventoAcessar::class)
            ->name('pagina-sprint-acessar-evento');
